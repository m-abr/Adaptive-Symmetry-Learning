...
class RolloutBuffer(BaseBuffer):
    ...
    def get(self, batch_size: Optional[int] = None, return_indices: Optional[bool] = False) -> Generator[RolloutBufferSamples, None, None]:
        assert self.full, ""
        ...
        while start_idx < self.buffer_size * self.n_envs:
            if return_indices:
                yield indices[start_idx : start_idx + batch_size], self._get_samples(indices[start_idx : start_idx + batch_size])
            else:
